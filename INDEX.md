...
| [A1](axioms/A1-sovereign-state-transparency.md) | axiom | Sovereign State Transparency | active |
| [A2](axioms/A2-isomorphic-specification.md) | axiom | Isomorphic Specification | active |
| [A3](axioms/A3-sovereign-composition.md) | axiom | Sovereign Composition | active |
| [A4](axioms/A4-zero-loss-knowledge.md) | axiom | Zero-Loss Knowledge | active |
| [A5](axioms/A5-perceptual-parity.md) | axiom | Perceptual Parity | active |
| [A6](axioms/A6-frictionless-agentic-collaboration.md) | axiom | Frictionless Agentic Collaboration | active |
| [A7](axioms/A7-resilient-agentic-operations.md) | axiom | Resilient Agentic Operations | active |
| [A8](axioms/A8-gated-recursive-integrity.md) | axiom | Gated Recursive Integrity | active |
| [A9](axioms/A9-chaos-validated-deployment.md) | axiom | Chaos-Validated Deployment | active |
| [A10](axioms/A10-autopoietic-evolution.md) | axiom | Autopoietic Evolution | active |
| [A11](axioms/A11-cognitive-minimalism.md) | axiom | Cognitive Minimalism | active |
| [A12](axioms/A12-precision-context-engineering.md) | axiom | Precision Context Engineering | active |
| [A13](axioms/A13-director-intent-amplification.md) | axiom | Director Intent Amplification | active |
| [A14](axioms/A14-compounding-learning.md) | axiom | Compounding Learning | active |
| [S1](style/S1-prereqs-explicit-cluster-agnostic.md) | style | Prerequisites explicit + cluster-agnostic + assumes authenticated tooling | active |
| [S2](style/S2-runnable-commands-in-code-blocks.md) | style | Runnable workflow steps belong in code blocks | active |
| [S3](style/S3-producer-consumer-doc-split.md) | style | Producer / consumer doc split | active |
| [S4](style/S4-four-journey-readme.md) | style | Four-journey README | active |
| [S5](style/S5-no-version-pins-in-prose.md) | style | No version pins in user-facing prose | active |
| [S6](style/S6-one-sentence-per-line.md) | style | One sentence per line (semantic line breaks) | active |
| [S7](style/S7-alternative-paths-separate-blocks.md) | style | Alternative paths in separate code blocks under subsections | active |
| [S8](style/S8-code-block-comments-not-prose.md) | style | Code-block comments are for what-the-line-does, not prose substitutes | active |
| [S9](style/S9-action-first-readme-structure.md) | style | Action-first README structure | active |
| [S10](style/S10-horizontal-rule-between-h2-sections.md) | style | Horizontal rule between top-level sections in long-form docs | active |
| [S11](style/S11-technical-identifiers-use-backticks.md) | style | Technical identifiers in prose use backticks | active |
| [S12](style/S12-code-block-introducer-own-paragraph.md) | style | Code-block introducer is its own paragraph | active |
| [S13](style/S13-plain-ascii-in-markdown.md) | style | Plain ASCII in markdown - typeable characters only | active |
| [M1](methodology/M1-triangulated-review.md) | methodology | Triangulated review - minimum 4 independent inputs | active |
| [M2](methodology/M2-test-drive-docs-by-execution.md) | methodology | Test-drive docs by execution | active |
| [M3](methodology/M3-default-reject-honest-yield.md) | methodology | Default-reject discipline + honest yield reporting | active |
| [M4](methodology/M4-frozen-history-rule.md) | methodology | Frozen-history rule | active |
...
| [D3](domains/D3-tooling-harness.md) | domain | tooling-harness - the launch/runtime harness | active |
...
| [W4](work-types/W4-validate-locally.md) | work-type | validate-locally - self-check a fresh artifact | active |
| [W5](work-types/W5-author-guard-or-falsifier-tests.md) | work-type | author-guard-or-falsifier-tests - add a test that can fail | active |
| [W6](work-types/W6-merge-and-land.md) | work-type | merge-and-land - land an approved change on canonical main | active |
| [W7](work-types/W7-publish-deploy-or-canonicalize.md) | work-type | publish-deploy-or-canonicalize - ship to the estate/channel | active |
| [W8](work-types/W8-verify-gate-reactive.md) | work-type | verify-gate-reactive - independently gate a build/change | active |
| [W9](work-types/W9-audit-a-surface.md) | work-type | audit-a-surface - bounded adversarial sweep of a surface | active |
| [W10](work-types/W10-adversarial-design-review-upstream.md) | work-type | adversarial-design-review-upstream - critique a design before build/merge | active |
| [W11](work-types/W11-run-a-live-probe-or-smoke.md) | work-type | run-a-live-probe-or-smoke - observe live behavior at a revision | active |
| [W12](work-types/W12-meta-validate-dogfood.md) | work-type | meta-validate-dogfood - use the deliverable as its own test | active |
| [W13](work-types/W13-code-owner-approve.md) | work-type | code-owner-approve - non-author independence approval | active |
| [W14](work-types/W14-design-a-contract-or-invariant.md) | work-type | design-a-contract-or-invariant - author a design-of-record | active |
| [W15](work-types/W15-convene-a-council.md) | work-type | convene-a-council - multi-lens deliberation + synthesis | active |
| [W16](work-types/W16-bank-idea-or-knowledge-capital.md) | work-type | bank-idea-or-knowledge-capital - capture reusable capital | active |
| [W17](work-types/W17-author-closeout-packet.md) | work-type | author-closeout-packet - proof-level arc closeout | active |
| [W18](work-types/W18-seed-a-blueprint-arc.md) | work-type | seed-a-blueprint-arc - instantiate a WorkGraph arc | active |
| [W19](work-types/W19-drive-an-arc.md) | work-type | drive-an-arc - operate an arc over its lifetime | active |
| [W20](work-types/W20-reconcile-ledger.md) | work-type | reconcile-ledger - reconcile entity/backlog state vs truth | active |
| [W21](work-types/W21-arc-repair.md) | work-type | arc-repair - repair a WorkGraph arc topology | active |
| [W22](work-types/W22-axiom-alignment-gate.md) | work-type | axiom-alignment-gate - per-item axiom-alignment check | active |
| [W23](work-types/W23-capture-decision-and-ratify.md) | work-type | capture-decision-and-ratify - record + ratify a decision | active |
