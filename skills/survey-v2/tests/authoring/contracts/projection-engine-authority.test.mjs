...
test("recomputed projection and assignment digests cannot authorize a rogue projection engine", async () => {
  const transaction = await loadCoreTransaction();
  transaction.byKind.get("ProjectionArtifact").spec.engine = {
    id: "rogue-engine",
    digest:
