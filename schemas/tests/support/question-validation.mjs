...
export const questionSchema = catalogSchemas.find(
  (entry) => entry.id === "urn:mission-kit:schemas:question:v1alpha1"
).schema;
...
export const validateQuestionStructure = ajv.getSchema(questionSchema.$id);

export function readExample(name) {
  return readJson(`question/v1alpha1/examples/${name}`);
}
