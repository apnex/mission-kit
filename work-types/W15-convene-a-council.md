...
Run a multi-lens deliberation over an open question - independent seats contribute framings, then a synthesis reconciles their disagreements into a convergence record that preserves minority claims.

---

## Evidence & closeability

The evidence contract is a single `doc`: the per-seat lens docs plus a synthesis that resolves the disagreements.\
Authority is `executor-evidence` - the convening architect owns the synthesis.\
