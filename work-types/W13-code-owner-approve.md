...
A code-owner (non-author) grants the independence approval a governed change requires to clear REVIEW_REQUIRED - an author-distinct identity attesting the PR, never the author's own sign-off.
